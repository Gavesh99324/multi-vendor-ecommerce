...
import { paginateQuery } from '../utils/helpers.js';
import { requireFields } from '../utils/validators.js';
import { recalcProductRating } from '../services/productService.js';

export const listProducts = asyncHandler(async (req, res) => {
    const { q, category, vendor, min, max, page = 1, limit = 12 } = req.query;
    ...
    const query = Product.find(filter).populate('category', 'name').populate('vendor', 'name vendor.shopName');
